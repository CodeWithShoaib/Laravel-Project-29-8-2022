    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="dataTable-container">
                <a class="btn btn-primary" href="{{ route('admin.C_Feedback.index') }}">Add Feedback</a>
                ...
                <thead>
                    ...
                    <th data-sortable="" style="width: 15.5989%;"><a href="#" class="dataTable-sorter">Sub Title</a></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{-- @dd($item->image) --}}
                            <img src="{{ asset('upload/Customer_Feedback/'.$item->image)}}" alt="image">

                        </td>
                        <td>
                            <a href="{{ route('admin.C_Feedback.edit',[$item->id])}}" class="btn btn-primary">Edit</a>
                            <form action="{{ route('admin.C_Feedback.destroy',[$item->id])}}" method="post">
                                @csrf
                                @method('DELETE')
