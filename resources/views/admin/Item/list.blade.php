    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="dataTable-container">
                <a class="btn btn-primary" href="{{ route('admin.items.index') }}">Add Products</a>

                <table id="datatablesSimple" class="dataTable-table">
                <thead>
                    <tr><th data-sortable="" style="width: 19.6379%;"><a href="#" class="dataTable-sorter">Id</a>
                    </th>
                    <th data-sortable="" style="width: 28.9694%;"><a href="#" class="dataTable-sorter">Name</a></th>
                    <th data-sortable="" style="width: 9.1922%;"><a href="#" class="dataTable-sorter">Image</a></th>
                    <th data-sortable="" style="width: 15.1811%;"><a href="#" class="dataTable-sorter">Price</a></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        <td>
                            <img src="{{ asset('upload/item/'.$item->image)}}" alt="image" style="width:200px; height:200px;">
                        </td>
                        <td>
                            {{ $item->price }}
