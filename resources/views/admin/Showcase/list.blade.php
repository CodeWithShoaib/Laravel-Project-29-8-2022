    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="dataTable-container">
                <a class="btn btn-primary" href="{{ route('admin.showcase.index') }}">Add Showcase</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{-- @dd($item->image) --}}
                            <img src="{{ asset('upload/showcase/'.$item->image)}}" alt="image">

                        </td>
                        <td>
                            <a href="{{route('admin.showcase.edit',[$item->id])}}" class="btn btn-primary">Edit</a>
                            <form action="{{ route('admin.showcase.destroy',[$item->id])}}" method="post">
                                @csrf
                                @method('DELETE')
